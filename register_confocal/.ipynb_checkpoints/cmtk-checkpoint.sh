...
SERVER=$2
ANALYZER=$3
# REF_PATH="/nfs/data${SERVER}/${ANALYZER}/data/${DATASET_NAME}/${DATASET_NAME}_confocal_rotated.nrrd"
REF_PATH="/nfs/data${SERVER}/${ANALYZER}/data/${DATASET_NAME}/${DATASET_NAME}_confocal_rotated_flipped.nrrd"
DATA_PATH="/nfs/data${SERVER}/${ANALYZER}/data/${DATASET_NAME}"

IMG_PATH="${DATA_PATH}/${DATASET_NAME}_ds_stack_mean.nrrd"
RESULT_PATH="${DATA_PATH}/${DATASET_NAME}_confocal_cmtk"
OUTPUT_NAME="${DATASET_NAME}_registered.nrrd"


OUTPUT_NAME_INIT="${DATASET_NAME}_registered_initial.nrrd"
OUTPUT_NAME_RIGID="${DATASET_NAME}_registered_rigid.nrrd"
OUTPUT_NAME_WARP="${DATASET_NAME}_registered_warp.nrrd"

OUTPUT_NAME_INIT_INV="${DATASET_NAME}_registered_initial_inv.nrrd"
OUTPUT_NAME_RIGID_INV="${DATASET_NAME}_registered_rigid_inv.nrrd"
OUTPUT_NAME_WARP_INV="${DATASET_NAME}_registered_warp_inv.nrrd"
